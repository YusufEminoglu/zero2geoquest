...
const T={{locate:'Map Hunt',bigger:'Value Duel',distance:'Distance Guess',silhouette:'Know the Shape',find:'Which place is this?',greater:'Which one has the greater value?',shape:'Whose silhouette is this?',correct:'Correct!',wrong:'Not this time.',next:'Next challenge →',done:'Quest complete!',again:'Play again'}};
